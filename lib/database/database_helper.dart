...
class DatabaseHelper {
  ...
  //insert ke database
  Future<int?> saveData(ModelDb modelDatabase) async {
  ...
  Future<int?> updateDataPemasukan(ModelDb modelDatabase) async {
    var dbClient = await checkDB;
  ...
  Future<int?> updateDataPengeluaran(ModelDb modelDatabase) async {
    var dbClient = await checkDB;
    return await dbClient!.update(tableName, modelDatabase.toMap(),
        where: '$columnId = ? and $columnTipe = ?',
  ...
  //hapus database pemasukan berdasarkan id
  ...
  //hapus database pengeluaran berdasarkan id
